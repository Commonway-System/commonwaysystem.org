...
- **"Working assessment" note removal.** Removing a leftover
  preliminary-review note that still appears on roughly half of all
  pattern pages, once those patterns get a real final review.
