...
- Surface material should be selected for the loads it will bear; a parking-lane application needs a different specification than a pedestrian-only buffer strip
