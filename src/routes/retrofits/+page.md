...
description: Every Retrofit Strategy currently in the Commonway System, grouped by scale, Network, Corridor, and Intersection.
date: 2026-09-03
llms: Index of every Retrofit Strategy in the Commonway System, grouped by scale (Network, Corridor, Intersection). A Retrofit Strategy describes how to move an existing street toward a Pattern.
---
...
Every Retrofit Strategy currently in the Commonway System, grouped by scale: Network, Corridor, and Intersection. See [How to read a retrofit strategy](/guide/how-to-read-a-retrofit-strategy/) for what each part of a Retrofit Strategy entry covers and how it relates to the Pattern catalog.
