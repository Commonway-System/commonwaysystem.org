...
<script>
  import { BlogIndex } from '$lib/theme/components'
</script>

Notes on how the Commonway System gets built: research, structural decisions, new patterns as they're added, and corrections when something earlier turns out to be wrong. Newest first.
