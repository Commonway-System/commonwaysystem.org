...
See [Bicycle Boulevard / Neighborhood Greenway](/guide/local-streets/bicycle-boulevard/) for a full worked example of a Pattern ID card, and the [Pattern Index](/guide/patterns/) for every pattern currently in the guide.
...
See the [Bicycle Boulevard](/guide/local-streets/bicycle-boulevard/) page's Design Speed section for numbered citations linking to a real References list in action.
