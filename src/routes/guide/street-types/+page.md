...
| -------------- | ------------------------------------------------------------------------------------------------------------- |
| **Local**      | All access, no through-traffic. Getting to your house or a nearby business is the entire point.               |
| **Collector**  | A middle step. Gathers traffic from Local streets and feeds it onto bigger roads. Some access, some movement. |
...
You'll run into pattern names like "Collector" attached to a bike path, or "Local" attached to a bus route, and that can look like a mistake at first. It isn't. Functional Classification isn't really about cars, it's about the job being done, and any mode of travel can do any of these jobs.

A dedicated bike path connecting one neighborhood to another is doing exactly the job a car Collector does, just for bikes instead of cars, so it's classified as a Collector. A car-free plaza that exists purely so people can walk to shops and linger is doing the same job a residential street does, just without cars, so it's classified as Local. The same logic sorts transit: a neighborhood bus loop plays a Local role, a bus route feeding a larger transit line plays a Collector role, a light-rail spine crossing a whole city plays an Arterial role, and commuter or heavy rail plays a Freeway-scale role. Once you're thinking in terms of the job rather than the vehicle, the classification makes sense for any mode.
...
Every classification above describes a stretch of street. Intersections & Crossings is different: it describes how two streets meet, and it applies across all four classifications rather than belonging to just one.
...
4. <span id="ref-4"></span><EvidenceChip tier="legal" /> National Association of City Transportation Officials (NACTO), _Urban Street Design Guide_, 2013. Available at: https://nacto.org/publication/urban-street-design-guide/
...
8. <span id="ref-8"></span><EvidenceChip tier="legal" /> CROW, _Basiskenmerken wegontwerp: Categorisering en inrichting van wegen_ (CROW-publicatie 315), Ede, 2012, updating the original 1997 Duurzaam Veilig categorization handbook. Available at: https://kennisbank.crow.nl/public/gastgebruiker/WOBU/Handboek_Verkeersveiligheid/Duurzaam_Veilig/20998
9. <span id="ref-9"></span><EvidenceChip tier="legal" /> CROW, _Ontwerpwijzer fietsverkeer_ (CROW-publicatie 230), 2006, revised 2016; published in English as _CROW Design Manual for Bicycle Traffic_, 2016. Available at: https://kennisbank.crow.nl/public/WOBI/Ontwerpwijzer_fietsverkeer/Woord_vooraf/33096
10. <span id="ref-10"></span><EvidenceChip tier="legal" /> CROW, _Richtlijn inpassing tram in stedelijke omgeving_, commissioned by Expertisecentrum Rail, superseding the 2007 _Leidraad inpassing tram in stedelijk gebied_. Available at: https://www.crow.nl/kennisproducten/richtlijn-inpassing-tram-in-stedelijke-omgeving/
